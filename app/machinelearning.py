...
import os # para acceder a los archivos del sistema operativo
...
def pipeline_model(path):
    ...
    (h, w) = img.shape[:2]
    # face detection 
    # blob: binary large object (imagen binaria grande) # 1.0: escala de la imagen, (300,300): tamaño de la imagen, (104.0,177.0,123.0): media de la imagen, swapRB: intercambiar rojo y azul, crop: recortar
    img_blob = cv2.dnn.blobFromImage(img, 1.0, (300, 300), (104.0, 177.0, 123.0), swapRB=False, crop=False)
