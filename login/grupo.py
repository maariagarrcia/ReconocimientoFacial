...
class ReconocimientoFacial:
    ...
    def abrir_ventana_gestos(self, nombre):
        # Aquí puedes implementar la lógica para manejar los gestos
        pass

    def actualizar_label_usuario(self, nombre):
        print(f"Bienvenido, {nombre}!")

    # Inside ReconocimientoFacial class
    def iniciar_reconocimiento(self):
        rostroscod = self.codrostros(self.images)
        cap = cv2.VideoCapture(0)
        recognized_names = []  # Collect recognized names
        ...
        while True:
            ...
            for facecod, faceloct in zip(facescod, faces):
                ...
                if comparacion[min_index]:
                    ...
                    recognized_names.append(nombre)  # Collect recognized names
        ...
        return recognized_names  # Return recognized names list
